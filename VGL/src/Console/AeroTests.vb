...
Public Module AeroTests
    ...
    Private Sub TestPanelVelocity()
        ...
        For I = 1 To 2
            ...
            Dim Qx As Double = (Panel.GetSourcePotentialInfluence(Rx, False) - Panel.GetSourcePotentialInfluence(P, False)) / Delta
            System.Console.WriteLine("dQ/dx = {0:F14}", (Qx))
            System.Console.WriteLine("Vx    = {0:F14}", (V.X))

            Dim Qy As Double = (Panel.GetSourcePotentialInfluence(Ry, False) - Panel.GetSourcePotentialInfluence(P, False)) / Delta
            System.Console.WriteLine("dQ/dy = {0:F14}", (Qy))
            System.Console.WriteLine("Vy    = {0:F14}", (V.Y))

            Dim Qz As Double = (Panel.GetSourcePotentialInfluence(Rz, False) - Panel.GetSourcePotentialInfluence(P, False)) / Delta
    ...
    ''' are equivalent to their induced velocity.
    ''' </summary>
    Private Sub TestFarFieldEquations()

        System.Console.WriteLine("Testing far field equations in quad panels")

        VortexRing4.FarFieldFactor = 3.0#
        ...
        For I = 1 To 2
            ...
            Dim V_SCF As New Vector3
            VortexRing4.UseFarFieldFormulas = False 
            Panel.AddSourceVelocityInfluence(V_SCF, P, False)
            
            Dim V_SFF As New Vector3
            VortexRing4.UseFarFieldFormulas = True 
            Panel.AddSourceVelocityInfluence(V_SFF, P, False)

            System.Console.WriteLine("V_CF = {0}", (V_SCF.ToString))
            System.Console.WriteLine("V_FF = {0}", (V_SFF.ToString))
          
            VortexRing4.UseFarFieldFormulas = False 
            Dim P_SCF as Double = Panel.GetSourcePotentialInfluence(P, False)
            
            VortexRing4.UseFarFieldFormulas = True 
            Dim P_SFF as Double = Panel.GetSourcePotentialInfluence(P, False)

            System.Console.WriteLine("P_CF = {0,17:F14}", (P_SCF))
            System.Console.WriteLine("P_FF = {0,17:F14}", (P_SFF))

            ' Dipole

            System.Console.WriteLine("Doublet:")

            Dim V_DCF As New Vector3
            VortexRing4.UseFarFieldFormulas = False 
            Panel.AddDoubletVelocityInfluence(V_DCF, P, 0.00001, False)
            
            Dim V_DFF As New Vector3
            VortexRing4.UseFarFieldFormulas = True
            Panel.AddDoubletVelocityInfluence(V_DFF, P, 0.00001, False)

            System.Console.WriteLine("V_CF = {0}", (V_DCF.ToString))
            System.Console.WriteLine("V_FF = {0}", (V_DFF.ToString))

            VortexRing4.UseFarFieldFormulas = False 
            Dim P_DCF as Double = Panel.GetDoubletPotentialInfluence(P, False)
            
            VortexRing4.UseFarFieldFormulas = True 
            Dim P_DFF as Double = Panel.GetDoubletPotentialInfluence(P, False)

            System.Console.WriteLine("P_CF = {0,17:F14}", (P_DCF))
            System.Console.WriteLine("P_FF = {0,17:F14}", (P_DFF))
